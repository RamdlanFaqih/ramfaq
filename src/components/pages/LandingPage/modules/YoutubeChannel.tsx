    ...
    return (
        <section className="min-h-screen py-20 px-6 md:px-12">
            <div className="max-w-7xl mx-auto">
                {/* Title */}
                <div className="mb-6">
                    <h2 className="text-xl md:text-4xl font-bold bg-secondary inline-block px-2 md:px-4 py-1">
                        Youtube Channel
                    </h2>
                </div>

                {/* Description */}
                <p className="text-sm md:text-xl mb-5 max-w-3xl">
                ...
                <Button className='bg-background text-text-primary border border-b-3 border-[#FF0000] cursor-pointer mb-10 dark:border-primary'>
                   My Channel
                </Button>
                </Link>
